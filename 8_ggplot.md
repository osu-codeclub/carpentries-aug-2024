# Creating publication quality graphics with R and ggplot2
...
You can think about a ggplot as being composed of layers. You start with
...
`gapminder` is a tibble (very similar to a data frame), comprised of
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-7-1.png)
...
Map `x = year` and `y = lifeExp`, and use `geom_point()` since we want a
scatterplot.
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-10-1.png)
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-11-1.png)
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-15-1.png)
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-16-1.png)
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-17-1.png)
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-23-1.png)
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-24-1.png)

All points are now open triangles, we are setting continent to `fill`
and making the outline black.
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-25-1.png)
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-26-1.png)
...
Then we can save it. I am indicating here to save the plot in a folder
...
Set labels within `labs().` Adjust theming with `theme()`. Check out the
...
![](8_ggplot_files/figure-commonmark/unnamed-chunk-33-1.png)
